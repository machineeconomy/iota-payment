...
module.exports = [
  ...
  {
    name: 'server-uri',
    question: 'Iotapay server uri (with protocol, hostname and port)',
    help: "Iotapay server uri (default: 'https://localhost:8443')",
  ...
  {
    name: 'config-path',
    question: 'Path to the config directory (for example: /etc/Iotapay-server)',
    default: './config',
    prompt: true
  },
  {
  ...
  },
  {
    ...
    help: 'HTTP port or \',\'-separated ports to redirect to the iotapay server port (e.g. "80,8080").',
    prompt: false,
    validate: function (value) {
